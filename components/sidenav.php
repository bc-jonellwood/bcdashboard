...
// Last modified: 2024/12/17 14:52:09
?>
...
<div class="sidenav-popover sidenav" popover="manual" name="sidenav-popver" id="sidenav-popover">
    <div class="d-flex flex-column p-1 sideNavMain"
        ...
        <ul class="nav nav-pills flex-column mb-auto">
            ...
            <li>
                <button class="nav-link d-flex align-items-center" id="mp-anchor" popovertarget="mp-popover" popovertargetaction="show">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="bi me-2 recolor" width="24" height="24">
...
<div id="mp-popover" class="mp-popover" popover="manual">
    ...
    <div class="popover-body">
        <div class="d-flex flex-column align-items-center">
            <ul class="nav nav-pills flex-column mb-auto">
                <li>
                    <a href="./mp.php" class="nav-link d-flex align-items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="bi me-2 recolor" width="24" height="24">
                ...
                <li>
                    <a href="./mpreservations.php" class="nav-link d-flex align-items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="bi me-2 recolor" width="24" height="24">
                ...
                <li>
                    <a href="./mpvehicles.php" class="nav-link d-flex align-items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="bi me-2 recolor" width="24" height="24">
