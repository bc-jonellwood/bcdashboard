<nav class="nav-blocks">
    ...
    <a href="myteam.php" class="nav-block">
        ...
        <!-- <img src="./images/phone.svg" alt="Employee" class="nav-block-icon recolor" /> -->
        Directory
    </a>
    <a href="https://office.outlook.com" class="nav-block">
        <svg xmlns="http://www.w3.org/2000/svg" width="1rem" height="1rem" viewBox="0 0 24 24" class="nav-block-icon recolor">
        ...
        <!-- <img src="./images/mail.svg" alt="Outlook" class="nav-block-icon recolor" /> -->
        Webmail
    </a>
    <a href="mailto: help@berkeleycountysc.gov" class="nav-block">
        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 20 20" class="nav-block-icon recolor">
    ...
    <?php if (isset($_SESSION['DepartmentNumber']) && $_SESSION['DepartmentNumber'] == 41515) { ?>
        <a href="https://status.berkeleycountysc.gov/dashboard" class="nav-block">
            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" class="nav-block-icon recolor">
