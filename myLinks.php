...
<body>
    <div class="main">
        ...
        <!-- <svg class="recolor" xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 100 100">
...
<style>
    ...
    .links-cards {
        width: 23dvi;
        /* background-color: light-dark(#ffffff60, #000000); */
        padding: 20px;
        ...
        .links-card-header {
            ...
            .ring-around {
                ...
                /* background-image: linear-gradient(to bottom right, #743ad5, #d53a9d); */
                padding: 5px;
                margin-left: 10px;
                margin-right: auto;
                /* margin-top: -70px; */
    ...
    .link-card {
        margin: 2px;
        margin-bottom: 10px;
        /* background-color: light-dark(#00000090, #ffffff20);
        color: light-dark(#ffffff20, #00000090); */
        background-color: light-dark(#5b89a1, #1b283c);
